    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-4 sm:left-6 top-0 bottom-0 w-px bg-secondary/30" />
          ...
          <div className="space-y-10 sm:space-y-12">
            {jobs.map((job, index) => (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-2.5 sm:left-4.5 top-1.5 w-3 h-3 rounded-full bg-secondary border-2 border-background" />

                <div className="border border-secondary/15 bg-black/30 backdrop-blur-sm rounded-lg p-5 sm:p-6">
                  ...
                  <ul className="mt-4 space-y-2">
                    {job.items.map((item, i) => (
                      <li
                        key={i}
                        className="text-sm sm:text-base text-primary/80 font-body flex items-start gap-2"
                      >
